export const EN = {
	...
	feedbackSection: {
		feedbacks: {
			...
			diegoPinheiro: {
				feedback:
					"I have been to several technology communities to seek interaction to share experiences, but none of them met my expectations like the Techmmunity. Organized and with a visionary sense, Techmmunity seeks to integrate people from different areas to produce knowledge and add value in the form of projects, thus enabling better qualifications to obtain a solid position in the job market.",
			},
			plactronic: {
				feedback:
	...
	techmmunityDivisionsSection: {
		...
		cards: {
			dev: {
				...
				description:
					"With an increasingly demanding market, professionals who are thinking of working in the area need to know more and more technologies from different areas. With that in mind, we created our programming division, which helps both the beginners and the more experienced to better understand the most used technologies on the market.",
			},
			graphic: {
				title: "Our graphic design division",
				description:
					"Design is a very creative area, but it requires knowledge of some very specific concepts that are complicated to learn on your own. We created our design division especially for this so that both professionals and aspirants in the field can share their experiences and refine their skills even more.",
			},
			song: {
				title: "Our sound design division",
				description:
					"When talking about sound design, the first thing that comes to mind is dubbing, however, this universe is much broader and more diverse. Sound design is necessary for almost all projects and we created this division to encourage the growth of the area.",
			},
			robotic: {
				title: "Our robotic engineering division",
				description:
					"Robotic engineering is a constantly expanding sector, both for industries and the entertainment of the general population. With our technological advancement, the demand for professionals capable of working in this area should grow more and more, so we created our technology sector to prepare professionals for this future demand.",
			},
			manager: {
				title: "Our management division",
				description:
					"Management encompasses several areas of any company, be it finance, human resources, entrepreneurship, and several others. We created the management division both for people who want to do a better job for the company they are employed in and for people who want to start their own.",
			},
		},
	},
