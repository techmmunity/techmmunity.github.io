...
export const FeedbackSection: React.FC = () => {
	...
	const feedbacksCards = [
		{
			id: 1,
			feedback: t("feedbackSection.feedbacks.alessandroRamos.feedback"),
			url: "https://github.com/alessandrohenriqueramos/",
			author: "Alessandro Ramos",
		},
		{
			id: 2,
			feedback: t("feedbackSection.feedbacks.diegoPinheiro.feedback"),
			url: "https://github.com/Ch1ron",
			author: "Diego Pinheiro",
		},
		{
			id: 3,
			feedback: t("feedbackSection.feedbacks.plactronic.feedback"),
